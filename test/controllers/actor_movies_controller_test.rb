...
class ActorMoviesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor_movie" do
    assert_difference('ActorMovie.count') do
      post actor_movies_url, params: { actor_movie: { actor_id: @actor_movie.actor_id, name: @actor_movie.name } }
    end
  ...
  test "should update actor_movie" do
    patch actor_movie_url(@actor_movie), params: { actor_movie: { actor_id: @actor_movie.actor_id, name: @actor_movie.name } }
